			...
			<form id="frm" name="frm" action="noticeupdate.do" method="post">
				...
				<div class="form-group">
					<input type="text" class="form-control" name="title" id="title"
						...
						value="${noticeupdate.title}" required />
				...
				<div class="form-group">
					<textarea class="form-control" id="content" name="content"
						rows="25" data-rule="required" placeholder="contents" required>${noticeupdate.content}</textarea>
				</div>
				<!--  컨텐츠 끝 -->
				...
				<input type="hidden" name="n_no" value="${noticeupdate.n_no}">
