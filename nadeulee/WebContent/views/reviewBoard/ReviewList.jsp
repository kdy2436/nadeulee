...
<div class="container">
	<ul class="timeline">
		<li>
			<!-- begin timeline-time --> <!-- end timeline-time --> <!-- begin timeline-icon -->
			<div class="timeline-icon">
				<a href="javascript:;">&nbsp;</a>
			</div> <!-- end timeline-icon --> <!-- begin timeline-body -->
			<div class="timeline-body">
				<div class="timeline-header">
					<input placeholder="Where have you been?"> <a
						href="javascript:;" class="m-r-15 text-inverse-lighter"><i
						class="fas fa-search fa-fw fa-lg m-r-3"></i></a>
				</div>
					...
					<div class="timeline-likes">
						<div class="stats-right">
							<label><input type="file" class="custom-file-input"
								id="customFile"><i
								class="far fa-image fa-fw fa-lg m-r-3"></i>image</label> &nbsp;
				...
				<c:forEach var="board" items="${boards }">
					<li>
						...
						<div class="timeline-time">
							<span class="date">${board.rdate }</span> <span class="time">04:20</span>
						...
						<div class="timeline-body">
							...
							<div class="timeline-likes">
								<div class="stats-right">
									<span class="stats-text">${board.content_id }</span> <span
										class="stats-text">${board.like } likes</span> <span
										class="stats-text">123 Comments</span>
								</div>
							</div>
							<div class="timeline-footer">
								<a href="javascript:;" class="m-r-15 text-inverse-lighter"><i
									class="fa fa-thumbs-up fa-fw fa-lg m-r-3"></i> Like</a> <a
									href="javascript:cDetails();"
							...
							<details id="cDetails">
								...
								<div class="timeline-comment-box">
									...
									<div>
										<span class="username">홍길동</span> <span
											class="pull-right text-muted">8:03 PM Today</span>
										<p>첫번째 글의 댓글내용</p>
									</div>
									<div class="timeline-comment-box">
										<div class="user">
