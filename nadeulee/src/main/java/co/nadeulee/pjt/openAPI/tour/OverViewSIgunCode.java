...
public class OverViewSIgunCode {
	...
	public static void main(String[] args) {
		...
		List<TourVO2> list = dao.selectId();
		JSONObject obj = null;
		...
		for (TourVO2 dto : list) {
			...
			String parameter = "&MobileOS=ETC&MobileApp=nadeulee&contentTypeId=" + dto.getTypeid() + "&contentId="
					+ dto.getContent_id();
	 ...
	 * 
	 */
	static void update(JSONObject obj, TourVO2 dto) {
	...
	/******************
	 * 
	 * 타입코드별로 나타나는 결과가 다르다. 다른 값을 dto에 저장해서 반환해주는 함수
	 * 
	 */
	static TourVO2 getKeyword(String typeid, TourVO2 dto, JSONObject obj) {
